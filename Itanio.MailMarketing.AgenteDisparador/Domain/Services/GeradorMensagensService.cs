    ...
    public static class GeradorMensagens
    {
        internal static IEnumerable<KeyValuePair<int, MailMessage>> Gerar(Mensagem mensagem)
        {
            ...
            foreach (var contato in contatosNaoEnviados)
            {
                ...
                var textView = AlternateView.CreateAlternateViewFromString(email.Body, null, MediaTypeNames.Text.Plain);
        ...
        private static string GerarCorpo(Mensagem mensagem)
        {
            ...
            var htmlMensagemCabecalho =
                $@"<table style='display:none' cellspacing=0 cellpadding=0><tr><td><img src='{url}acessou.asp?m={mensagem.Id}&e=_$Emai$_' alt='Acesse o site da Infra'></td></tr></table>
                    ...
                    <table border='0' cellpadding='0' cellspacing='0' class='title' height='163' style='background-color: #5b6789; width:100%;'>
                        <tbody>
                            <tr><td colspan = '3' height='138' style='text-align:center; background-color:#d93044;'>
                                <a href='{url}link.asp?l={mensagem.IdLinkHome}&e={mensagem.Id}&m=IdUsuario'>
            ...
            var corpo = new StringBuilder(htmlMensagemCabecalho);
            ...
            var htmlMensagemRodape =
                $@"<tr><td>&nbsp;</td><td valign='top'>&nbsp;</td><td>&nbsp;</td></tr></tbody></table></td></tr><tr><td> 
                                           <table border='0' cellpadding='0' cellspacing='0' class='final-news' style='background-color: #bb3642;'>
                                            ...
                                            <a style='color:#000; text-decoration:none; font-size:11px;' href='{url}link.asp?b=1&l={mensagem.IdLinkBloqueio}&e={mensagem.Id}&m=IdUsuario'> 
                                            Não desejo receber informativos da Revista Infra </a></div></td></tr></tbody></table>";

            corpo.Append(htmlMensagemRodape);

            var strCorpo = corpo.ToString().Replace("href=mailto", "href2=mailto")
        ...
        {
            var htmlMensagemPersonalizada = string.Empty;
        ...
        {
            var repo = new DapperMensagemRepository();
            mensagem.IdLinkHome = repo.InserirLink(mensagem.Id, "http://www.revistainfra.com.br");
            mensagem.IdLinkBloqueio = repo.InserirLink(mensagem.Id,
                $"http://www.revistainfra.com.br/tool/upmail/Bloquear.asp?e=IdUsuario&m={mensagem.Id}");
            mensagem.Empresas.ForEach(empresa => empresa.IdLink = repo.InserirLink(mensagem.Id, empresa.WebSite));
            mensagem.Noticias.ForEach(noticia => noticia.IdLink = repo.InserirLink(mensagem.Id,
                $"http://www.revistainfra.com.br/Textos/{noticia.Id}/{noticia.Titulo.Replace(' ', '-')}"));
        }


        private static string GerarParteMensagemEmpresas(Mensagem mensagem)
        {
            var htmlEmpresas = new StringBuilder();
            ...
            foreach (var item in mensagem.Empresas)
            {
                ...
                if (item.Figura.Length > 0)
                {
                    ...
                    htmlEmpresas.Append(
                        $"<a href='http://www.revistainfra.com.br/tool/upmail/link.asp?m={item.Id}&l={item.IdLink}&e={mensagem.Id}' target='_blank' style='text-decoration:none;color: #172d59;font-weight:normal;'>");
                    htmlEmpresas.Append(
                        $"<img alt='' src='http://www.revistainfra.com.br/arquivos/{item.Figura}'/></a></td></tr>");
                }

                htmlEmpresas.Append(
                    "<tr><td><h2 style='color: #172d59;font-weight: normal;font-size: 25px;font-family: Arial;margin:12px 0 0 0px;'>");
                htmlEmpresas.Append(
                    $"<tr><td><h2 style='color: #172d59;font-weight: normal;font-size: 25px;font-family: Arial;margin:12px 0 0 0px;'>{item.RazaoSocial}</h2>");
                htmlEmpresas.Append(
                    $"</td></tr><tr><td width='365'><p style='color: #515354;font-size: 16px;font-family: Arial;line-height: 22px; martin-bottom:5px;'>");
                htmlEmpresas.Append(
                    $"{item.Endereco}<br />{item.Cidade}/{item.Estado}<br />{item.Bairro}-{item.CEP}<br />({item.DDDTelefone}) {item.Telefone}<br />{item.WebSite}");
                htmlEmpresas.Append(
                    $"</p></td></tr><tr><td><table border='0' cellpadding='10' cellspacing='5' width='240'>");
                htmlEmpresas.Append($"<tbody><tr><td style='background-color:#d93044'>");
                htmlEmpresas.Append(
                    $"<a href='http://www.revistainfra.com.br/tool/upmail/link.asp?m={item.Id}&l={item.IdLink}&e={mensagem.Id}' target='_blank' style='font-family:arial; font-size:16px; font-weight:bold; color:white; text-decoration:none;'>");
                htmlEmpresas.Append(
                    $"Visite o site dessa empresa</a></td></tr></tbody></table></td></tr><tr><td>&nbsp;</td></tr></tbody></table></td><td width='30'>");
        ...
        {
            var htmlNoticias = new StringBuilder();

            if (mensagem.Noticias.Count > 0)
                htmlNoticias.Append(
                    @"<tr><td width='30'>&nbsp;</td><td style='color:#172d59;font-weight: bold;font-size: 34px;font-family: Arial;margin:0; padding-top:30px;'>Notícias do setor de FM</td><td width='30'>&nbsp;</td></tr>
            ...
            foreach (var item in mensagem.Noticias)
            {
                ...
                if (item.FiguraNewsletter.Length > 0)
                    htmlNoticias.Append(
                        $@"<tr><td><a href='http://www.revistainfra.com.br/tool/upmail/link.asp?m={item.Id}&l={item.IdLink}&e={mensagem.Id}' target='_blank' style='text-decoration:none;color: #172d59;font-weight:normal;'>
                ...
                htmlNoticias.Append(
                    @"<tr><td><h2 style='color:#172d59;font-weight: normal;font-size: 25px;font-family: Arial;margin: 0 0 0px;'>");
                htmlNoticias.Append($"{item.Titulo}</h2></td></tr><tr><td width='365'>");
                htmlNoticias.Append(
                    $"<p style='color: #515354;font-size: 16px;font-family: Arial;line-height: 22px;martin-bottom:5px;'>{item.Resumo}");
                htmlNoticias.Append(
                    $"</p></td></tr><tr><td><table border='0' cellpadding='10' cellspacing='5' width='150'>");
                htmlNoticias.Append($"<tbody><tr><td style='background-color:#d93044'>  ");
                htmlNoticias.Append(
                    $"<a href='http://www.revistainfra.com.br/tool/upmail/link.asp?m={item.Id}&l={item.IdLink}&e={mensagem.Id}' target='_blank' style='font-family:arial; font-size:16px; font-weight:bold; color:white; text-decoration:none;'>");
                htmlNoticias.Append(
                    $"Leia na &iacute;ntegra</a></td></tr></tbody></table></td></tr><tr><td>&nbsp;</td></tr></tbody></table></td><td width='30'>");
